...
{
    public class ElevenLabSoundRequestedItem : VisualElementComponent, IRequestedItem
    {
        public new class UxmlFactory : UxmlFactory<ElevenLabSoundRequestedItem, UxmlTraits>
        {
        }
        ...
        public ElevenLabSoundRequestedItem()
        {
            ...
            {
                Application.OpenURL(value.GeneratorResult["url"]!.ToObject<string>());
            };
        ...
        public async Task Save(Request request)
        {
            ...
            var model = await MeshyModelHelper.DownloadFileAsync(request.GeneratorResult["url"]!.ToObject<string>());
